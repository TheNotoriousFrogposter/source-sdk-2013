...
int g_aWeaponDamageTypes[] =
{
	...
	DMG_BULLET  | DMG_NOCLOSEDISTANCEMOD | DMG_PREVENT_PHYSICS_FORCE,	// TF_WEAPON_RAYGUN,
	...
	DMG_BULLET  | DMG_NOCLOSEDISTANCEMOD | DMG_PREVENT_PHYSICS_FORCE,	// TF_WEAPON_DRG_POMSON,

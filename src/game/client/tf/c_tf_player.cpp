...
ConVar ff_disable_falldamage_scream( "ff_disable_falldamage_scream", "0", FCVAR_USERINFO | FCVAR_ARCHIVE, "" );

ConVar tf_respawn_on_loadoutchanges( "tf_respawn_on_loadoutchanges", "1", FCVAR_USERINFO | FCVAR_ARCHIVE, "When set to 1, you will automatically respawn whenever you change loadouts inside a respawn zone." );
